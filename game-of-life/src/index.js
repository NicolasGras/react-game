...
class Main extends React.Component {
    ...
    selectBox = (row, col) => {
        ...
        // We make a copy of this.state.gridFull because
        // state must not be modified directly
        let gridCopy = arrayClone(this.state.gridFull);
        // let jsonStrGrid = JSON.stringify(this.state.gridFull);
        // let gridCopy = JSON.parse(jsonStrGrid);
    ...
    seed = () => {
        ...
        for(let i = 0 ; i < this.rows ; i++) {
            for(let j = 0 ; j < this.cols ; j++) {
                ...
                // 25% chance to have box having 'live' state
